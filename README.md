...
* ./doc/swagger/scopes (folder)
  ...
  Define the OAuth2 scopes of the API (optional). This file gets regenerated by the swagger:grape:generate_doc at each run. However, the description part is left untouched.
...
You can use the rake swagger:generate_client:all 
